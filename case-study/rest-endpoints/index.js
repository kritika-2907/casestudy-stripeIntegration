...
app.post('/create-checkout-session', async (req, res) => {
  ...
  const lineItems = [{
    price_data: {
      currency: "usd",
      product_data: {
        name: products.planName,
        description: products.planDescription, // Optional
      },
      unit_amount: Math.round(products.prepaidBalance * 100), // Convert to cents
    },
    quantity: 1, 
  }]; 
